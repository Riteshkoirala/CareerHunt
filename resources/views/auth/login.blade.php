                ...
                <div class="container-fluid cont">
                    <div class="p-2">
                        ...
                        <div>
                            ...
                            <a class="form-control d-flex justify-content-center" style="background-color: skyblue" href="{{ route('linkedinSignIn') }}"><i class="bi-linkedin " style="color: darkblue ; font-size: 25px"></i></a>
                            <a class="form-control bg-black d-flex justify-content-center" href="{{ route('githubSignIn') }}"><i class="bi-github text-light" style="font-size: 25px"></i></a>
                        </div>
                        <div>
