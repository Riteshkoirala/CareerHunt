...
@section('content')
    ...
    <div class="container mb-5" style="margin-top: 40px; width: 100%; padding-left: 0; padding-right: 0;">
        <div class="left-column m-2 p-2" style="height: 200px">
            Left Column
        </div>
                    ...
                    <div class=" d-flex justify-content-center">
                        <div class="p-4"
                            ...
                            <div class="d-flex">
                                ...
                                <span class="mx-2" style="font-weight: bold; font-size: 15px;">Ritesh Koirala</span>
                                <em style="margin-top:20px; margin-left: -110px; font-size: 10px;">{{ $post->created_at->diffForHumans() }}
                                    <i class="bi-globe text-danger"></i></em>
                                @if(Auth::user())
                                    @if(Auth::user()->id == $post->user_id)
                                        <span style="position:relative; left: 68%"> <a class="eddd"
                                        ...
                                        <form action="{{ route('post.destroy', $post) }}" method="POST"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button class="ddd" style="position:absolute; border: none; left: 66%"
                        ...
                        <div class="p-3 d-flex justify-content-center" style="margin-top: -10px" >
                            <div style=" border: 1px solid black; border-radius: 10px; border-top: none; box-shadow: 0px 0px 0px 5px lightgrey; width: 90%;">
                                <form>
                                    <input type="text" class="form-control" style="border: 1px solid black" placeholder="write a comment">
                                </form>
                                <div class=" d-flex justify-content-center">
                                    <div class="p-2"
                                         style="box-shadow: 2px 2px 10px 5px lightgrey; border-radius: 20px; width: 600px">
        ...
        <div class="right-column m-2 p-2 position-relative" style="height: 200px">
            Right Column
        </div>
    </div>
    <script>
